          ...
          // bloc.pinState? _otpKey.currentState.validate():_loginKey.currentState.validate() ;
           ...
           if(res){
             ...
             showSnackBarMessage("Sorry something went wrong try after sometime");
              ...
              otp.sendOtp('${mobileTextCtrl.text.trim()}','${rNum}',
                  1111, 9999, '+91');
          ...
          children: [
            ...
            Container(
              padding: EdgeInsets.only(top: 10,bottom: 20),
                  child: Text('SELF-QUARANTINE',style: TextStyle(fontSize: 13.0,color: Colors.white),),),
            Container(
              margin: EdgeInsets.only(left: 10),
              padding: EdgeInsets.only(bottom: 20),
              child: Text('What is your current \n   health condition?',style: TextStyle(fontSize: 16.0,color: Colors.white,letterSpacing: 1),),),
            CardComponent(status: 'COVID-19 Positive',text: 'I was tested and my results \nwere positive',image: 'card_image_1',),
            SizedBox(height: 20,),
            CardComponent(status: 'COVID-19 Negative',text: 'I was tested and my results \nwere negative',image: 'card_image_2',),
            SizedBox(height: 20,),
            CardComponent(status: 'COVID-19 Symptoms',text: 'I haven\'t been tested but i have \nCOVID-19 symptoms',image: 'card_image_3',),
            SizedBox(height: 20,),
            CardComponent(status: 'COVID-19 Quarantine',text: 'I want to put myself under \nself-quaratine',image: 'card_image_4',),
            SizedBox(height: 20,),
            RaisedButton(
